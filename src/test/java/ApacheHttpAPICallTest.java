 ...
 */
public class ApacheHttpAPICallTest {
    @Test
    public void getFaceId() throws Exception {
        ...
        String id = ApacheHttpAPICall.getFaceId(jsonResp);
        assertTrue(id.equals("c5c24a82-6845-4031-9d5d-978df9175426"));
        id = ApacheHttpAPICall.getFaceId(jsonRespErr1);
        assertTrue(id.isEmpty());
        id = ApacheHttpAPICall.getFaceId(jsonRespErr2);
        assertTrue(id.isEmpty());
    }
