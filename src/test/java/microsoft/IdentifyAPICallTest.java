 ...
 */
public class IdentifyAPICallTest {
    @Test
    public void readResponseJson() throws Exception {
        ...
        assertTrue(IdentifyAPICall.readResponseJson(jsonResp).equals("25985303-c537-4467-b41d-bdb45cd95ca1"));
        assertTrue(IdentifyAPICall.readResponseJson(jsonResp1).isEmpty());
        assertTrue(IdentifyAPICall.readResponseJson(jsonResp2).isEmpty());
    }
