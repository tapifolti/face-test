...
public class ApacheHttpVerifyAPICallTest {
    ...
    public void readResponseJson() throws Exception {
        ...
        String jsonResp1 = "{\"error\":{\"code\":\"Unspecified\",\"message\":\"Access denied due to invalid subscription key. Make sure you are subscribed to an API you are trying to checkIfSame and provide the right key.\"}}";
        String jsonResp2 = "{\"error\":{\"statusCode\":403,\"message\":\"Out of checkIfSame volume quota. Quota will be replenished in 2.12 days.\"}}";
